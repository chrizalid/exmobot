...
import hmac, hashlib
import requests
url = "https://api.telegram.org/bot487254848:AAGeDF1xFgp65lW7oGZfZjJVEqrKBafLjbY/"
chat_id = "486723618"
...
API_KEY = 'K-34dedf9c3b3155d13195c44908878811545fcc45'
# обратите внимание, что добавлена 'b' перед строкой
API_SECRET = b'S-26e4765e5333d3308691e0db74566ccdf277f73d'
...
CAN_SPEND = 500 # Сколько тратить CURRENCY_2 каждый раз при покупке CURRENCY_1
...
STOCK_TIME_OFFSET = -4 # Если расходится время биржи с текущим 
    ...
    try:
        ...
        for order in opened_orders:
            if order['type'] == 'sell':
                ...
                raise ScriptQuitCondition('Выход, ждем пока не исполнятся/закроются все ордера на продажу usd_rub (один ордер может быть разбит биржей на несколько и исполняться частями)')
            else:
